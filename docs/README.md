# Documentação do Signal

- [Instalação e deploy](deployment.md): Docker Compose, instalação pelo código, proxy HTTPS, atualização e backup.
- [Configuração e operação](configuration.md): providers, idioma, banco, arquivos e solução de problemas.
